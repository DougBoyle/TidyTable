...
{
    // Same as th regular Huffman coding program, but for 12-bit values represented as shorts
    public class Huffman12
    {
        public static int Compress(short[] input, byte[] output, int inputLength)
        {

            var huffman = new Huffman12();
